...
const enVerticals: Record<VerticalKey, Vertical> = {
  property: {
    ...
    landing: {
      ...
      video: "/videos/tile-harbour-day.mp4",
        ...
        tiles: [
          {
            ...
            video: "/videos/feature-orbit.mp4",
          },
          {
            title: "Harbour towers",
            tag: "Apartment Living",
            video: "/videos/tile-harbour-towers.mp4",
          },
          {
            title: "Church & gardens",
            tag: "Heritage Setting",
            video: "/videos/tile-heritage.mp4",
          },
        ],
      },
      exteriors: {
        ...
        tiles: [
          {
            title: "City at dusk",
            tag: "Twilight Aerials",
            video: "/videos/tile-city-dusk.mp4",
          },
          {
            title: "Riverside homes",
            tag: "Waterfront Living",
            video: "/videos/tile-river-homes.mp4",
          },
          {
            title: "Suburb to skyline",
            tag: "Development Showcase",
            video: "/videos/tile-suburb-skyline.mp4",
          },
        ],
      },
    },
